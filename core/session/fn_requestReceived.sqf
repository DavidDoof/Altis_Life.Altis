...
switch (playerSide) do {
    case west: {
		...
		life_clero_cop_dienstnummer = parseNumber(_this select 12);
		life_clero_ausweis = _this select 13;
    };
    ...
    case civilian: {
		...
		life_clero_skills = _this select 16;
		life_clero_ausweis = _this select 17;
    };
    ...
    case independent: {
		...
		life_clero_ausweis = _this select 10;
    };
};
