#include "..\..\script_macros.hpp"
    ...
    */
private ["_maxGather", "_resource", "_amount", "_requiredItem", "_mined","_lvlmaster","_xpmaster","_res_name","_lvlres","_xpres","_skillCfgMaster","_lvl_xp_master","_skillCfgRes","_resource_skillCfg","_masterlvl","_lvl_xp","_lvlxp_master_next","_xp_res","_xp_master","_quantity_max","_lvlxp_next","_new_xp_masterlvl","_new_xp_res","_new_lvl_masterlvl","_new_lvl_res","_new_life_clero_skills","_master_set","_arr"];
...
//get CFG RES
_skillCfgRes = missionConfigFile >> "CfgSkills" >> "Minerals";
