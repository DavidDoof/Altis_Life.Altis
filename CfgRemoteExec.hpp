...
class CfgRemoteExec {
    class Functions {
		...
		F(life_fnc_moveMnts,CLIENT)
		F(life_fnc_Radio,CLIENT)
		...
		F(life_fnc_attachheadphones,ANYONE)
		F(life_fnc_attachgunnysack,ANYONE)
		F(life_fnc_removeheadphones,ANYONE)
		F(life_fnc_removegunnysack,ANYONE)
		F(life_fnc_showAusweis,ANYONE)
    };
