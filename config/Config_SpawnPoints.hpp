...
class CfgSpawnPoints {
    ...
    class Altis {
        class Civilian {
            ...
            class Kavala {
                displayName = "Kavala";
                spawnMarker = "kavala_spawn";
                icon = "\a3\ui_f\data\map\MapControl\watertower_ca.paa";
                conditions = "license_civ_licKavala";
            };

            class Athira {
                displayName = "Athira";
                spawnMarker = "athira_spawn";
                icon = "\a3\ui_f\data\map\MapControl\watertower_ca.paa";
                conditions = "license_civ_licAthira";
            };

            class Pyrgos {
                displayName = "Pyrgos";
                spawnMarker = "pygros_spawn";
                icon = "\a3\ui_f\data\map\MapControl\watertower_ca.paa";
                conditions = "license_civ_licPygros";
            };

            class Sofia {
                displayName = "Sofia";
                spawnMarker = "sofia_spawn";
                icon = "\a3\ui_f\data\map\MapControl\watertower_ca.paa";
                conditions = "license_civ_licSofia";
            };
