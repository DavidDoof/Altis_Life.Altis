...
/* Database Related Settings */
    ...
    saved_virtualItems[] = { "handcuffs","fuelkiller","zipties","headphones","gunnysack","pickaxe","fuelEmpty","fuelFull", "spikeStrip", "lockpick", "defuseKit","storageSmall","storageBig","redgull","coffee","waterBottle","apple","peach","tbacon","donuts","rabbit","salema","ornate","mackerel","tuna","mullet","catshark","turtle_soup","hen","rooster","sheep","goat","defibrillator","toolkit", "flashlightshoulder", "spikeStrip","lockpick","goldbar","blastingcharge","boltcutter","defusekit","heroin_unprocessed","cannabis","cocaine_unprocessed","turtle_raw","oil_unprocessed","oil_processed","copper_unrefined","copper_refined","iron_unrefined","iron_refined","salt_unrefined","salt_refined","sand","glass","diamond_uncut","diamond_cut","rock","cement" }; //Array of virtual items that can be saved on your player.
    ...
    save_vehicle_items[] = { "handcuffs","fuelkiller","zipties","headphones","gunnysack","pickaxe","fuelEmpty","fuelFull", "spikeStrip", "lockpick", "defuseKit","storageSmall","storageBig","redgull","coffee","waterBottle","apple","peach","tbacon","donuts","rabbit","salema","ornate","mackerel","tuna","mullet","catshark","turtle_soup","hen","rooster","sheep","goat","defibrillator","toolkit", "flashlightshoulder", "spikeStrip","lockpick","goldbar","blastingcharge","boltcutter","defusekit","heroin_unprocessed","cannabis","cocaine_unprocessed","turtle_raw","oil_unprocessed","oil_processed","copper_unrefined","copper_refined","iron_unrefined","iron_refined","salt_unrefined","salt_refined","sand","glass","diamond_uncut","diamond_cut","rock","cement" };
...
/* System Settings */
    ...
    news_broadcast_header_length = 500; //Number of characters that a header can consist of. Anything over this may clip. This depends on the font size and various other factors. Adjust with caution.
    ...
    escapeMenu_displayText = "Bis Bald!"; //Text displayed in the escape menu. Make it short.. around 20 characters.

    /* Fuel System Configurations */
    pump_service = true; //Allow users to use pump service on the map. Default = false
    fuel_cost = 85; //Cost of fuel per liter at fuel stations (if not defined for the vehicle already).
    service_chopper = 300000; //Cost to service chopper at chopper service station(Repair/Refuel).
    fuelCan_refuel = 7500; //Cost to refuel an empty fuel canister at the fuel station pumps. (Be wary of your buy/sell prices on fuel cans to prevent exploits...)
    ...
    gang_upgradeBase = 150000; //The base cost for purchasing additional slots in a gang
    ...
    paycheck_cop = 3600; //Payment for cops
    paycheck_civ = 250; //Payment for civillians
    paycheck_med = 4800; //Payment for medics
